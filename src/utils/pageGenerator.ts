            ...
            <div class="grid md:grid-cols-3 gap-8 mb-12">
                ${template.features.items.map((feature: any) => `
                    <div class="rounded-lg border bg-card text-card-foreground shadow-sm p-6 ${isPremium ? 'bg-white/10 backdrop-blur-sm border-white/20' : ''}">
                        <div class="w-16 h-16 flex items-center justify-center rounded-full mb-4 mx-auto" style="background: ${template.styles.primaryColor}20; border: 2px solid ${template.styles.primaryColor}; color: ${template.styles.primaryColor};">
                            <i class="ri-${feature.icon} text-2xl"></i>
                        </div>
