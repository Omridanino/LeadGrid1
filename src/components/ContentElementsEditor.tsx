    ...
    <div className="w-80 bg-gray-900 border-l border-gray-700 h-full overflow-y-auto">
      <div className="p-4">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-white text-lg font-bold">עורך תוכן ואלמנטים</h2>
        ...
        <Tabs defaultValue="content" className="w-full">
          <TabsList className="grid w-full grid-cols-2 bg-gray-800">
            ...
            <TabsTrigger value="elements" className="text-white data-[state=active]:bg-blue-600">
          ...
          <TabsContent value="elements" className="space-y-4 mt-4">
            <Card className="bg-gray-800 border-gray-700">
              <CardHeader>
                <CardTitle className="text-white text-sm">ניהול אלמנטים</CardTitle>
              </CardHeader>
