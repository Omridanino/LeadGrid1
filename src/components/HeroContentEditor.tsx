                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-1">
                    <input
                      ...
                      onChange={(e) => setLocalColors({ ...localColors, heroBackground: e.target.value })}
                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-1">
                    <input
                      ...
                      onChange={(e) => setLocalColors({ ...localColors, headlineColor: e.target.value })}
                      className="w-12 h-8 rounded border-gray-600"
                    />
                    <Input
                      value={localColors.headlineColor}
                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-1">
                    <input
                      ...
                      onChange={(e) => setLocalColors({ ...localColors, subheadlineColor: e.target.value })}
                      className="w-12 h-8 rounded border-gray-600"
                    />
                    <Input
                      value={localColors.subheadlineColor}
                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-1">
                    <input
                      ...
                      onChange={(e) => setLocalColors({ ...localColors, badgeColor: e.target.value })}
                      className="w-12 h-8 rounded border-gray-600"
                    />
                    <Input
                      value={localColors.badgeColor}
                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-1">
                    <input
                      ...
                      onChange={(e) => setLocalColors({ ...localColors, primaryButtonBg: e.target.value })}
                      className="w-12 h-8 rounded border-gray-600"
                    />
                    <Input
                      value={localColors.primaryButtonBg}
                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-1">
                    <input
                      ...
                      onChange={(e) => setLocalColors({ ...localColors, secondaryButtonBorder: e.target.value })}
                      className="w-12 h-8 rounded border-gray-600"
                    />
                    <Input
                      value={localColors.secondaryButtonBorder}
