...
const LandingPagePreview = ({ content, currentColors, formData, heroImage, elements = [] }: LandingPagePreviewProps) => {
  ...
  const renderGlassmorphismCard = (children: React.ReactNode, hoverScale: boolean = true) => (
    <div 
      className={`group relative p-4 rounded-2xl transition-all duration-700 cursor-pointer border ${hoverScale ? 'hover:scale-105' : ''}`}
      style={{ 
    ...
    <Card className="bg-gray-900 border-gray-700 overflow-hidden">
      <CardContent className="p-0">
        ...
        {renderGlassmorphismSection(
          <div 
            className="p-6 text-center min-h-[400px] flex flex-col justify-center relative"
            style={{
          ...
          >
            ...
            <div className="relative z-10">
              <Badge 
                className="mb-3 text-sm px-4 py-1.5 border-2 animate-pulse"
                style={{ 
              ...
              <p 
                className="text-base md:text-lg mb-5 max-w-2xl mx-auto leading-relaxed"
                style={{ 
              ...
              <Button 
                size="lg" 
                className="text-base px-6 py-3 shadow-2xl rounded-xl hover:scale-110 transition-all duration-700 font-bold mb-6 relative overflow-hidden"
                style={{ 
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-4 max-w-3xl mx-auto">
                {Object.entries(content.stats).map(([key, value], index) => (
                  <div 
                    key={index} 
                    className="p-3 rounded-2xl hover:scale-110 transition-all duration-700 shadow-2xl"
                    style={{ 
                  ...
                  >
                    <div className="text-xl md:text-2xl font-bold text-white mb-1" style={{ textShadow: '0 5px 15px rgba(0,0,0,0.5)' }}>{value as string}</div>
        ...
        {content.whyChooseUs && renderGlassmorphismSection(
          <div className="p-6">
            ...
            >
              <Award className="w-8 h-8 ml-2 inline animate-bounce" style={{ color: currentColors.accent }} />
              {content.whyChooseUs.title}
            </h2>
            <p className="text-center text-base mb-8 opacity-90" style={{ color: currentColors.text }}>
                  ...
                  {renderGlassmorphismCard(
                    <div className="p-4">
                      <div className="relative mb-4">
                        <div 
                          className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto group-hover:scale-125 group-hover:rotate-12 transition-all duration-700 relative"
                          style={{ 
                      ...
                      <div className="text-center relative">
                        <p 
                          className="text-base leading-relaxed font-bold group-hover:text-opacity-100 transition-all duration-700"
                          style={{ 
                            color: currentColors.text,
            ...
            <div className="text-center mt-12">
              ...
              <Button 
                size="lg"
                className="px-12 py-4 text-lg font-bold rounded-2xl hover:scale-110 transition-all duration-700 shadow-2xl relative overflow-hidden"
                style={{ 
                  background: `linear-gradient(135deg, ${currentColors.accent}, ${currentColors.primary}, ${currentColors.secondary})`,
                  color: 'white',
        ...
        {renderGlassmorphismSection(
          <div className="p-6">
            ...
            >
              <Users className="w-6 h-6 ml-2 animate-bounce" style={{ color: currentColors.secondary }} />
              {content.aboutTitle}
            </h2>
        ...
        {renderGlassmorphismSection(
          <div className="p-6">
            ...
            >
              <Quote className="w-6 h-6 ml-2 animate-bounce" style={{ color: currentColors.primary }} />
              מה אומרים עלינו
            </h2>
        ...
        {renderGlassmorphismSection(
          <div className="p-6">
            ...
            >
              <HelpCircle className="w-6 h-6 ml-2 animate-bounce" style={{ color: currentColors.secondary }} />
              שאלות נפוצות
            </h2>
          ...
          <div className="p-6">
            <div className="max-w-3xl mx-auto text-center">
              {renderGlassmorphismCard(
                <div className="p-6">
                  <h2 
                    className="text-xl md:text-2xl font-bold mb-4 flex items-center justify-center"
                    style={{ 
                      color: currentColors.contactColor || currentColors.text,
                      textShadow: '0 4px 8px rgba(0,0,0,0.4)'
                    }}
                  >
                    <MessageCircle className="w-5 h-5 ml-2 animate-bounce" style={{ color: currentColors.accent }} />
                  ...
                  <Button 
                    className="text-base px-8 py-3 rounded-xl hover:scale-110 transition-all duration-700 font-bold shadow-2xl"
                    style={{ 
                      background: `linear-gradient(135deg, ${currentColors.primary}, ${currentColors.secondary})`, 
                      color: 'white',
                      border: 'none',
