...
export const HeroSection = ({ content, currentColors, formData, heroImage }: HeroSectionProps) => {
      ...
      <section className="section-hero relative overflow-hidden min-h-screen bg-white dark:bg-neutral-950">
        ...
        <div className="container-hero relative z-10">
          <div className="text-center">
            ...
            <p className="typography-body text-xl md:text-2xl text-gray-600 dark:text-gray-300 leading-relaxed mb-12 max-w-4xl mx-auto animate-slide-up animate-delay-2">
      ...
      <section className="section-hero relative overflow-hidden min-h-screen bg-black">
        ...
        <div className="container-hero relative z-10">
          <div className="text-center">
            ...
            <p className="typography-body text-xl md:text-2xl text-gray-300 leading-relaxed mb-12 max-w-4xl mx-auto animate-slide-up animate-delay-2">
  ...
  // Dynamic Gradients Hero Style
  if (formData.designStyle === 'dynamic-gradients') {
    return (
