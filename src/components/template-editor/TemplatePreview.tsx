        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="text-white" style={{ backgroundColor: template.styles.accentColor }}>
              {template.hero.button1Icon && <i className={`ri-${template.hero.button1Icon} mr-2`}></i>}
              {template.hero.button1Text}
            </Button>
            <Button size="lg" className="text-white" style={{ backgroundColor: template.styles.secondaryColor }}>
              {template.hero.button2Icon && <i className={`ri-${template.hero.button2Icon} mr-2`}></i>}
        ...
        <section className={`py-16 px-4 relative ${getEffectClasses(template.effects?.emotional)}`} style={getSectionStyle(template.styles.emotionalBackground, template.styles.emotionalBackgroundImage)}>
          ...
          <div className="max-w-6xl mx-auto text-center relative z-10">
            {template.emotional.badge && (
              <Badge className="mb-4" style={{ backgroundColor: template.styles.accentColor, color: '#ffffff' }}>
                {template.emotional.badge}
              </Badge>
            )}
            ...
            <p className="text-lg max-w-4xl mx-auto" style={{ color: template.styles.emotionalBackgroundImage ? '#ffffff' : template.styles.textColor, opacity: 0.9 }}>
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-12">
            ...
            {template.features.subtitle && (
              <p className="text-xl" style={{ color: template.styles.featuresBackgroundImage ? '#ffffff' : template.styles.textColor, opacity: 0.8 }}>
                {template.features.subtitle}
              </p>
            )}
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {template.features.items.map((feature, index) => (
              <Card key={index} className={`p-6 text-center ${template.effects?.features === 'glass-morph' ? 'glass-effect' : ''}`}>
                <div className="w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center" style={{ backgroundColor: template.styles.primaryColor + '20', border: `2px solid ${template.styles.primaryColor}` }}>
                  <i className={`ri-${feature.icon} text-2xl`} style={{ color: template.styles.primaryColor }}></i>
                </div>
                <h3 className="text-xl font-bold mb-4" style={{ color: template.styles.textColor }}>{feature.title}</h3>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {template.testimonials.testimonials.map((testimonial, index) => (
              <Card key={index} className={`p-6 ${template.effects?.testimonials === 'glass-morph' ? 'glass-effect' : ''}`}>
                ...
                <p className="mb-4 text-right" style={{ fontStyle: 'italic', color: template.styles.textColor, opacity: 0.9 }}>
                  "{testimonial.content}"
                </p>
                <div>
      ...
      <section className={`py-16 px-4 relative ${getEffectClasses(template.effects?.about)}`} style={getSectionStyle(template.styles.aboutBackground, template.styles.aboutBackgroundImage)}>
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-lg max-w-4xl mx-auto" style={{ color: template.styles.aboutBackgroundImage ? '#ffffff' : template.styles.textColor, opacity: 0.9 }}>
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-12">
            ...
            {template.pricing.subtitle && (
              <p className="text-xl" style={{ color: template.styles.pricingBackgroundImage ? '#ffffff' : template.styles.textColor, opacity: 0.8 }}>
                {template.pricing.subtitle}
              </p>
            )}
          </div>
